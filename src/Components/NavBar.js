        ...
        <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4 relative">
            <nav className="flex justify-between items-center py-6">
                ...
                <div className='text-base text-primary font-medium space-x-5 hidden lg:block '>
                    <Link to="/login" className='inline-block py-2 px-4 border border-primary rounded-md text-primary hover:bg-blue hover:text-white transition duration-300 ease-in-out'>Login</Link>
                    <Link to="/sign-up" className='inline-block py-2 px-4 bg-blue rounded-md text-white hover:bg-opacity-75 transition duration-300 ease-in-out'>Sign up</Link>
                </div>
            </nav>
            {isMenuOpen && isMobile && (
